...
export default function SideNav(props) {
  ...
  useEffect(() => {
    // this is the code block that gets executed when our ref changes (so in this case it' when the ref is asigned)
    console.log(ref);
  ...
  return (
    <section ref={ref} className={"nav " + (showNav ? "" : " hidden-nav ")}>
      ...
      <h4 id="easy" className="text-gradient">
        Easy Breezy Notes
      </h4>
      <div className="full-line"></div>
      <button onClick={handleCreateNote}>
        <h3 id="easy">New note</h3>
